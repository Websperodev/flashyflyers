										  ...
										  <?php if($FiledsKey['type']=="notes_to_graphic_designer"){ ?>
											...
											<?php if($FiledsKey['type']=="multiple_file"){ ?>
												...
												if(! empty( $filesData ) ){
															...
															if(file_exists( SITE_BASE_PATH."/uploads/custom_product/" . $files)){
											...
											<?php } ?>
											 ...
											 <?php if($FiledsKey['type']=="single_file"){ ?>
                                                ...
                                                <?php 
												if(! empty( $Filedsvalue ) && file_exists( SITE_BASE_PATH."/uploads/custom_product/" . $Filedsvalue)){
															...
															echo '<div class="ImagesCustom popup-gallery">';
															if($uploadedFileType=="jpg" || $uploadedFileType=="jpeg" || $uploadedFileType=="png" || $uploadedFileType=="gif"){
																echo '<a href="'.SITEURL.'/uploads/custom_product/'.$Filedsvalue.'" class="text-white magnificPopup WhiteText"><img src="'.SITEURL.'/uploads/custom_product/'.$Filedsvalue.'" width="50" height="50"></a>';
															}else{
																echo '<a href="'.SITEURL.'/uploads/custom_product/'.$Filedsvalue.'" download class="text-white WhiteText"><i class="fa fa-download"></i><br></a>';	
															}
															echo '</div></div>';
														 } 
											...
											if($FiledsKey['type']=="add_music" ){ ?>
												...
												if(! empty( $musicFile ) && file_exists( SITE_BASE_PATH."/uploads/custom_product/" . $musicFile)){
															...
															echo '<div class="ImagesCustom popup-gallery">';
															if($uploadedFileType=="jpg" || $uploadedFileType=="jpeg" || $uploadedFileType=="png" || $uploadedFileType=="gif"){
																echo '<a href="'.SITEURL.'/uploads/custom_product/'.$musicFile.'" class="text-white magnificPopup WhiteText"><img src="'.SITEURL.'/uploads/custom_product/'.$musicFile.'" width="50" height="50"></a>';
															}else{
																echo '<a href="'.SITEURL.'/uploads/custom_product/'.$musicFile.'" download class="text-white WhiteText"><i class="fa fa-download"></i><br></a>';	
															}
															echo '</div></div>';
														 } 
