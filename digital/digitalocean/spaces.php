...
class Spaces {
  ...
  */
  function create($name, $region, $privacy = "public") {
...
class Space {
  ...
  */
  ...
  Creates this Space.
  */
  function create($privacy = "public") {
  ...
  */
  ...
  Uploads text.
  */
  function upload($text, $saveAs, $privacy = "public") {
    if($privacy == "public") { $privacy = "public-read"; }
  ...
  Uploads a file.
  */
  function uploadFile($filePath, $saveAs = "", $privacy = "public") {
  ...
  */
  ...
  Copies a file.
  */
  function copyFile($filePath, $saveAs, $toSpace = "", $privacy = "public") {
