      ...
      $original_name = basename( $_FILES["image"]["name"]);
        ...
        list($width, $height) = getimagesize($_FILES["image"]["tmp_name"]);
		 ...
		 $sourceProperties = getimagesize($_FILES["image"]["tmp_name"]);
  		//for listing	
		  ProductImageThumbCreate($sourceProperties,$imageFileType,$_FILES["image"]["tmp_name"],$ImageNewName."_245X354",SITE_BASE_PATH.$target_dir,354);
		  //for product details
		  ProductImageThumbCreate($sourceProperties,$imageFileType,$_FILES["image"]["tmp_name"],$ImageNewName."_389X568",SITE_BASE_PATH.$target_dir,568);
