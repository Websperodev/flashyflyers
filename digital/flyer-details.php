                                                    ...
                                                    <?php if($p['filetype'] == 'image') {
                                                       ...
                                                       // {
                                                           ...
                                                           <!-- <iframe allowfullscreen="true"
                                                            ...
                                                            ?>
                                                            <video controls poster="<?php echo SITEURL; ?>uploads/products/<?=$productID;?>/<?=getProductBannerImageSize($p['filename'],$productID,'568');?>" class="player" id="player" >
                                         ...
                                         <?php 
												if(!empty($preSelectionCustom)){ 
													foreach($preSelectionCustom as $singlekey=>$singlevalue){
															...
															$imageUrl = SITEURL."uploads/custom_product/".$singlevalue;
															?>
      ...
      <div class="ownSongProDetails"  <?php if(!empty($productVals['type_banner'] ) && in_array("Use my music",$productVals['type_banner'] )){ ?>  style="display:block;"<?php } ?>>
                                   ...
                                   <div class="img-upload">
                                        ...
                                        <label class="custom-control custom-checkbox" style="margin-top:15px;margin-left:5px;">
                                            ...
                                            <div class="buy-btns mt-4">
                                                <a class="buy-btn addon_buy" ><span class="price" id="totalCartAmount">$<?php if(!empty($preSelection['totalPrice'])) { echo formatPrice($preSelection['totalPrice']); } else { echo formatPrice($product['Baseprice']); }?></span> <span class="buy-label"><i class="fas fa-shopping-cart"></i> Proceed</span></a>
						...
						if(strstr(strtolower($_SERVER['HTTP_USER_AGENT']), 'mobile') || strstr(strtolower($_SERVER['HTTP_USER_AGENT']), 'android')) {}
                            ...
                            <form method="post" name="addon_form" style="margin-top:20px" enctype="multipart/form-data">
                                <div class="product-options p-4">
                                    <div class="d-block mb-3">
                                        <label class="custom-control custom-radio">
                                            <input type="radio" name="flyer_dimension" <?=($preSelection['dimensional']=="2D" || empty($preSelection['dimensional'])) ? 'checked':''?> class="custom-control-input dimensionalCheck" value="2D">
      ...
      <div class="ownSongProDetails"  <?php if(!empty($productVals['type_banner'] ) && in_array("Use my music",$productVals['type_banner'] )){ ?>  style="display:block;"<?php } ?>>
                                   ...
                                   <div class="img-upload">
                                        ...
                                        <label class="custom-control custom-checkbox" style="margin-top:15px;margin-left:5px;">
                                            ...
                                            <div class="buy-btns mt-4">
                                                ...
                                                <a class="buy-btn addon_buy" data-order-type="template"><span class="price" id="totalCartAmount">$<?php if(!empty($preSelection['totalPrice'])) { echo formatPrice($preSelection['totalPrice']); } else { echo formatPrice($product['Baseprice']); }?></span> <span class="buy-label"><i class="fas fa-shopping-cart"></i> Proceed</span></a>
                                           <?php /*?><div class="ProoccedBtn"><input type="button" value="Proceed"></div><?php */?>
            ...
            <div class="productDetailsTags productDetailsTagsMobile">
                        <h3>Tags</h3>
                        	<ul>
                            	<?php foreach($tagsLists  as $tag){ ?>
                            	<li><a href="<?php echo SITTE_URL; ?>search.php?tag=<?php echo $tag['TagSlug']; ?><?php echo ($IsCustomProduct=="yes") ?"&type=custom":""; ?>"><?php echo $tag['TagName']; ?></a></li>
                                <?php } ?>
                            </ul>
                        </div>
            <?php } ?>
            ...
            <div class="getRelatedImages">
            		...
            		<div class="RelatedImagesSlider" id="RelatedImagesSlider">
                    	...
                    	<?php foreach($getRelatedApproveImages['small'] as $singleKey=>$single){ 
								...
								$imageURLLarge =SITEURL."uploads/work/".$getRelatedApproveImages['large'][$singleKey];
								echo "single".$single;
						?>
