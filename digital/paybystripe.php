                    ...
                    if ( $settingarr['auto_assign'] == 'Yes' ) {
                        ...
                        $insertOrder = InsertRcrdsGetID( ["TransactionID",
                                                          ...
                                                          "Music",
														    "OrderStatus",
                                                          "parent_product_id",
                                                          "own_song","deejay_name","ename","presenting","customeProductsFileds","rep_order"], [$paymentRecord,
                                                                        $orders['totalPrice'],
                                                                        $orders['dimensional'],
                                                                        $typeBanners,
                                                                        $orders['defaultSize'],
                                                                       ...
                                                                       addslashes($customData['main_title']),
																		...
																		"1",
                                                                        $parent_product_id,
                                                                        addslashes($customData['own_song']),addslashes($customData['deejay_name']),addslashes($customData['ename']),addslashes($customData['presenting']),$customFiledsProduct,$rep_order], ORDER );
                    } else {
                        $insertOrder = InsertRcrdsGetID( ["TransactionID",
                                                          "TotalPrice",
                                                          "Dimensional",
