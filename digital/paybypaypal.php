    ...
    foreach ( $cart as $orders ) {
        ...
        $insertOrder = InsertRcrdsGetID( ["TransactionID",
                                              ...
                                              "own_song","OrderStatus","deejay_name","ename","presenting","customeProductsFileds","rep_order"], [$paymentRecord,
                                                            ...
                                                            $parent_product_id,
                                                            addslashes($customData['own_song']),"4",addslashes($customData['deejay_name']),addslashes($customData['ename']),addslashes($customData['presenting']),$customFiledsProduct,$rep_order], ORDER );
