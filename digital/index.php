                ...
                <?php
                 foreach($flyersArr as $key => $flyerArr) {
                    ...
                    if ( ! empty( $flyerArr['image_path'] )) {
                        ...
                        <div class="item">
                            <?php 
							echo  FlayerImageSrc($flyerArr['image_path'],'550','img-fluid');
							?>
    ...
    <section class="hm-section-5 hm-section-2 pb-5 template-block" >
        <div class="container">
            <div class="template-block-title" id="flyer-templates">
                ...
                <h2 class="h2">From scratch <img src="./images/new-img.png" alt=""></h2>
            </div>
            <div class="book-container">
                <div class="book-container-inner">
                    <div class="book-block book-block-template">
                        <div class="book-block-img">
                            <div class="book-block-img-wrap">
                                <img src="./images/blue-img.png" alt="">
                            </div>
                        </div>
                    ...
                    <div class="book-block book-block-scratch">
                        <div class="book-block-img">
                            <div class="book-block-img-wrap">
                                <img src="./images/saffron-img.png" alt="">
                            </div>
                        </div>
                        <div class="book-block-content">
