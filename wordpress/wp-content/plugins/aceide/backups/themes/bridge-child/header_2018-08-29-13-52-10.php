    ...
    <header class="header-desktop">
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light bg-light main-nav">
                <a class="navbar-brand" href="index.html"><?php echo qode_get_logo(array(
									'logo_image' => true,
                                )); ?></a>
                 <?php echo qode_get_logo(array(
									'logo_image' => true,
                                )); ?>
