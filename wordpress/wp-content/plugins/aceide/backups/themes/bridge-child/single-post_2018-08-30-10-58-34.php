...
<div class="page-wrap pb-5 pt-3 bubble-bg-3">
    <div class="container">
        ...
        <div class="blog-single bx-shadow">
            <p class="post-meta"><i class="far fa-calendar-alt"></i><span><?=get_the_date('d/m/Y',get_the_ID())?></span> <i class="far fa-clock"></i><span><?php the_time( 'H:i:s' ); ?></span></p>
            <h1><?=get_the_title()?></h1>
