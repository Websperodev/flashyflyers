                    ...
                    if(isset($_SESSION['userId']) && !empty($_SESSION['userId'])) {
                        ...
                        <div class="dropdown account-dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="account-btn">
                                ...
                                <a class="dropdown-item" href="<?=ADMINURL;?>products.php">Products</a>
                        ...
                        <li class="nav-item" id="login-btn">
                        	<a class="nav-link" href="<?=SITEURL;?>profile.php">Account</a>
                    	</li>
                        <li class="nav-item" id="register-btn">
                            <a class="nav-link" href="<?=SITEURL;?>logout.php">Logout</a>
                        </li>
                        <?php
						} else {
						?>
