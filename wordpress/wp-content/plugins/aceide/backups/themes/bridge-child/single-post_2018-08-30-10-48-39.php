...
die();
/* end AceIDE restore code */ ?><div class="page-wrap pb-5 pt-3 bubble-bg-3">
    <div class="container">

        <div class="blog-single bx-shadow">
            <p class="post-meta"><i class="far fa-calendar-alt"></i><span>12/08/2018</span> <i class="far fa-clock"></i><span>10:23 AM</span></p>
            <h1>The Power Of Community At Service Lane</h1>
            <figure class="text-center">
                <img src="images/blog-big.jpg" class="img-fluid" alt="">
            </figure>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex eacommodo consequat. Duis
