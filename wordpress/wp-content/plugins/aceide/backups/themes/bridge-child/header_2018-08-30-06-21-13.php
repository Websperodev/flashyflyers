    ...
    <header class="header-desktop">
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light bg-light main-nav">
                <a class="navbar-brand" href="https://flashyflyers.com/developer/index.php"><img src="<?php echo esc_url($qode_options_proya['logo_image']); ?>" class="img-fluid" alt=""></a>
                 <div class="ml-sm-auto cart-mobile">
                    <div class="cart">
                        <a href="https://flashyflyers.com/developer/cart.php"><i class="fas fa-shopping-cart"></i></a>
               ...
               <span class="navbar-toggler-icon"></span>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="https://flashyflyers.com/developer/index.php">Flyer Templates</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="https://flashyflyers.com/developer/about.php">About us</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="https://flashyflyers.com/developer/contact.php">Contact us</a>
                        </li>
                        <li class="nav-item" id="login-btn">
                            <a class="nav-link" href="https://flashyflyers.com/developer/login.php">Login</a>
                        </li>
                        <li class="nav-item" id="register-btn">
                            <a class="nav-link" href="https://flashyflyers.com/developer/signup.php">Sign up</a>
                        </li>
                    </ul>
