 ...
 <footer class="footer">
        <div class="container">
            <div class="footer-logo text-center mb-5">
                <a href="<?php get_site_url() ?>"><img src="<?php echo esc_url($qode_options_proya['logo_image_light']); ?>" class="img-fluid" alt=""></a>
            </div>
