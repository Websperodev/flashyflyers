    ...
    ?>
      <div class="col-md-4 col-sm-6 mb-4">
        <article class="post-item">
          ...
          <h3><a href="<?=get_the_permalink() ?>">
            <?=get_the_title() ?>
            </a></h3>
          <?php echo substr(get_the_content(),0,100); ?>.... <a class="read-more" href="<?=get_the_permalink() ?>">Read more</a> </article>
      </div>
      <?php endwhile; ?>
    </div>
