...
<body class="<?php echo esc_url($qode_options_proya['logo_image']); ?>">
    <header class="header-desktop">
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light bg-light main-nav">
                <a class="navbar-brand" href="index.html"><img src="" class="img-fluid" alt=""></a>
